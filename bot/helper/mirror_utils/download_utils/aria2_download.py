...
class AriaDownloadHelper(DownloadHelper):
    ...
    def __onDownloadStarted(self, api, gid):
        ...
        if STOP_DUPLICATE_MIRROR:
            if smsg:
                dl.getListener().onDownloadError(f'<b>File Has Been Uploaded Previously Into The Team Drive 📁.\n\nKindly Search Next Time Before Mirroring, This Download Has Been Cancelled. ❌</b>\n\n')
    ...
    def __onDownloadStopped(self, api, gid):
        ...
        dl = getDownloadByGid(gid)
        if dl: dl.getListener().onDownloadError('𝗧𝗢𝗥𝗥𝗘𝗡𝗧 𝗜𝗦 𝗗𝗘𝗔𝗗 ❌')
